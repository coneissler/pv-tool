        ...
        <div className={cellClasses.Cell}>
            <svg viewBox='0 0 629 189' xmlns='http://www.w3.org/2000/svg' xmlnsXlink='http://www.w3.org/1999/xlink'
                ...
                <rect x='166.159' y='76.668' width='268.982' height='23.257' fill='#b0b0b0'
                      transform='matrix(.97479 0 0 1.07493 33.339 7.587)' />
                <rect x='166.159' y='76.668' width='268.982' height='23.257' fill='#b0b0b0'
                      transform='matrix(.97479 0 0 1.07493 33.339 73.587)' />
                <text fontSize='15' fill='#1e467d' textAnchor="middle"
                      transform='translate(318.351 108.839) scale(1.18084)'>{this.props.data.joinDate}</text>
                <ellipse cx='189.661' cy='110.309' rx='16.121' ry='15.809' fill='#fff'
                         stroke='#b0b0b0' transform='matrix(.99252 0 0 1.01209 -1.562 -9.346)' />
                <rect x='166.159' y='76.668' width='268.982' height='23.257' fill='#fff'
                      stroke='#b0b0b0' strokeWidth='.97' transform='matrix(.9748 0 0 1.07493 17.628 40.587)'
                />
                <ellipse cx='189.661' cy='110.309' rx='16.121' ry='15.809' fill='#fff'
                         stroke='#b0b0b0' transform='matrix(.99252 0 0 1.01209 -1.562 56.857)' />
                ...
                {this.props.data.uniShort.length === 3 ? (<text fontSize='15'
                      fill='#1e467d' transform='matrix(.84557 0 0 .84557 171.804 173.039)'>{this.props.data.uniShort}</text>) :
                (<text fontSize='15' fill='#1e467d' transform='matrix(.84557 0 0 .84557 178.31 172.961)'>{this.props.data.uniShort}</text>)}
                <text fontSize='12.415'
                      fill='#1e467d' transform='translate(168.824 70.388) scale(2.01374)'>{this.props.data.memberstatus}</text>
                ...
                />
                <text fontSize='15' fill='#1e467d' textAnchor="middle"
                      transform='translate(318.351 141.839) scale(1.18084)'>{this.props.data.major.substring(6)}</text>
                <text fontSize='15' textAnchor="middle"
                      fill='#1e467d' transform='translate(318.351 174.839) scale(1.18084)'>{this.props.data.university}</text>
                <path d='M75.784,11.889C75.784,9.799 74.087,8.102 71.996,8.102L64.42,8.102C62.33,8.102 60.633,9.799 60.633,11.889L60.633,20.437C60.633,22.528 62.33,24.225 64.42,24.225L71.996,24.225C74.087,24.225 75.784,22.528 75.784,20.437L75.784,11.889Z'
                      fill='#477d14' transform='translate(3.322 2.837)' />
                <defs>
